defmodule Transporter.Tcp do
  ...
  @doc "Callback implementation for `c:Transporter.send/2`, via `:gen_tcp.send/2`"
  defdelegate send(sock, content), to: :gen_tcp

  @spec recv(socket, non_neg_integer) :: {:ok, binary} | {:error, term}
  @doc "Callback implementation for `c:Transporter.recv/2`, via `:gen_tcp.recv/2`."
  defdelegate recv(sock, length), to: :gen_tcp

  @spec recv(socket, non_neg_integer, timeout) :: {:ok, binary} | {:error, term}
  @doc "Callback implementation for `c:Transporter.recv/3`, via `:gen_tcp.recv/3`."
  ...
  NB: `Transporter.Tcp` defaults to using a binary tcp port.
  """
  ...
  @doc section: :server
  @doc """
  Callback implementation for `c:Transporter.handshake/2`.
